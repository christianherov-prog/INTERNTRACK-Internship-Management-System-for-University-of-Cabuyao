...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'account.active'])->group(function () {
        ...
        Route::prefix('student')->middleware('role:student')->group(function () {
            ...
            Route::get('/supervisor-feedback', [StudentController::class, 'supervisorFeedback']);
            ...
            Route::post('/evaluations', [StudentController::class, 'submitEvaluation']);
        ...
        Route::prefix('supervisor')->middleware('role:supervisor')->group(function () {
            ...
            Route::patch('/feedback/{id}', [SupervisorController::class, 'updateFeedback']);
            Route::delete('/feedback/{id}', [SupervisorController::class, 'deleteFeedback']);
        ...
        Route::prefix('faculty')->middleware('role:faculty,coordinator')->group(function () {
