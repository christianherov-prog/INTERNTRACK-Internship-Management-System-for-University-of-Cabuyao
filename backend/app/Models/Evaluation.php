...
class Evaluation extends Model {
    use SoftDeletes;
    protected $fillable = ['internship_id','evaluator_type','evaluated_by','evaluation_period','technical_skills','communication_skills','teamwork','initiative','work_ethics','attendance_punctuality','adaptability','problem_solving','total_score','average_score','rating','strengths','areas_for_improvement','general_comments','submitted_at','signer_name','signature_path','signed_at'];
    protected $casts = ['submitted_at'=>'datetime','signed_at'=>'datetime'];
    ...
    public function getSignatureUrlAttribute(): ?string { return SignatureCapture::url($this->signature_path); }
