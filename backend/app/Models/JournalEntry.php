...
class JournalEntry extends Model {
    use SoftDeletes;
    protected $fillable = ['internship_id','entry_number','date','activities_summary','learnings','challenges','hours_declared','status','supervisor_feedback','supervisor_reviewed_by','supervisor_reviewed_at','faculty_feedback','faculty_reviewed_by','faculty_reviewed_at', 'week_number', 'file_path', 'notes'];
