        ...
        <ToastProvider>
          <ConfirmProvider>
            ...
            <Routes>
              ...
              <Route path="/faculty/documents" element={<ProtectedRoute allowedRoles={['faculty', 'coordinator']}><FacultyDocuments /></ProtectedRoute>} />
              <Route path="/faculty/reports" element={<ProtectedRoute allowedRoles={['faculty', 'coordinator']}><FacultyReports /></ProtectedRoute>} />
              <Route path="/faculty/messages" element={<ProtectedRoute allowedRoles={['faculty', 'coordinator']}><FacultyMessages /></ProtectedRoute>} />
              <Route path="/faculty/meetings" element={<ProtectedRoute allowedRoles={['faculty', 'coordinator']}><MeetingsPage bodyClass="faculty-page" canCreate /></ProtectedRoute>} />
              <Route path="/faculty/supervisor-approvals" element={<ProtectedRoute allowedRoles={['faculty', 'coordinator']}><CoordSupervisorApprovals apiBase="/faculty" bodyClass="faculty-page" /></ProtectedRoute>} />
              <Route path="/faculty/settings" element={<ProtectedRoute allowedRoles={['faculty', 'coordinator']}><FacultySettings /></ProtectedRoute>} />
