...
import CoordManageRequirements from './pages/coordinator/CoordManageRequirements'
        ...
        <ToastProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/faculty/students/:userId/progress" element={<ProtectedRoute role="faculty"><FacultyStudentProgress /></ProtectedRoute>} />
              ...
              <Route path="/coordinator/requirements" element={<ProtectedRoute role="coordinator"><CoordManageRequirements /></ProtectedRoute>} />
