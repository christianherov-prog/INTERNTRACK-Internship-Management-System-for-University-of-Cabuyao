...
function MisdSectionMappings() {
  ...
  return (
    <Layout title="Section Mappings" subtitle="Faculty â†” section assignments by term" icon="fa-sitemap" bodyClass="admin-page">
          ...
          <form className="p-3" onSubmit={handleSubmit}>
            <div className="row g-3">
              ...
              <div className="col-md-6">
                ...
                <input className="form-control" value={form.program} onChange={(e) => setForm((p) => ({ ...p, program: e.target.value }))} />
              </div>
              <div className="col-md-6">
                  ...
                  <tr key={row.id}>
                    ...
                    <td className="text-center">
                      <div className="btn-group btn-group-sm">
                        <button className="btn btn-outline-green" onClick={() => openEdit(row)}><i className="fa fa-pen"></i></button>
