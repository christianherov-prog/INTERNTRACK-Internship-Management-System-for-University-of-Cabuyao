              ...
              <div className="content-card h-100">
                ...
                <form className="p-3" onSubmit={lookupStudent}>
                  <div className="input-group">
                    ...
                    />
                    <button className="btn btn-green" type="submit" disabled={busy}>Lookup</button>
                  </div>
                </form>
                {preview && (
                    ...
                    <div className="row g-2" style={{ fontSize: '0.9rem' }}>
                      <div className="col-md-6">
                        <div className="border rounded p-2 h-100">
                          ...
                          <div>Program: {preview.misd?.program || '—'}</div>
                        ...
                        <div className="border rounded p-2 h-100">
                          ...
                          {preview.local ? (
                            <>
                              ...
                              <div>Program: {preview.local.program || '—'}</div>
          ...
          <div className="content-card mb-4">
            <div className="content-card-header d-flex justify-content-between align-items-center">
              ...
              <div className="btn-group btn-group-sm">
                <button className="btn btn-outline-green" disabled={busy} onClick={() => loadDirectory('students')}>Students</button>
                <button className="btn btn-outline-green" disabled={busy} onClick={() => loadDirectory('faculty')}>Faculty</button>
              </div>
            </div>
            <div className="p-3">
              {!directory ? (
