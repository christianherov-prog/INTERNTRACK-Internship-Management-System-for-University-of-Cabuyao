        ...
        <div className="content-card mb-4">
          ...
          <form className="p-3" onSubmit={handleSubmit}>
            <div className="row g-3">
              ...
              <div className="col-md-3"><label className="form-label fw-semibold">MOA Expiry</label><input type="date" className="form-control" value={form.moa_expiry_date} onChange={e => setForm(p => ({...p, moa_expiry_date: e.target.value}))} /></div>
          ...
          {loading ? (
            ...
            <div className="table-responsive">
              <table className="table table-hover mb-0">
                ...
                <tbody>
                  {data.length === 0 ? <tr><td colSpan={7} className="text-center text-muted py-4">No companies registered.</td></tr>
                    : data.map(c => (
                    <tr key={c.id}>
