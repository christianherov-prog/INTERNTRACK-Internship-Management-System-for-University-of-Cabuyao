      ...
      <div className="content-card">
        ...
        <div className="table-card">
          {loading ? (
            ...
            <div className="text-center py-4 text-muted"><i className="fa fa-check-circle fa-2x mb-2 d-block text-success"></i>No pending journals.</div>
          ) : journals.map(j => {
              ...
              <div key={j.id} className="p-3 border-bottom">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    ...
                    <div className="text-muted" style={{fontSize:'0.82rem'}}>{new Date(j.date).toLocaleDateString('en-PH',{weekday:'long',month:'long',day:'numeric'})} · {j.hours_declared} hrs</div>
