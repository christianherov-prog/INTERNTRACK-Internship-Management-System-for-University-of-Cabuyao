...
function AbsorptionModal({ internship, onClose, onSaved }) {
  ...
  const submit = (e) => {
    ...
    setSaving(true)
    setError(null)
    api.patch(`/supervisor/internships/${internship.id}/absorption`, {
...
function SupervisorAbsorption() {
  ...
  return (
    <Layout title="Intern Absorption" subtitle="Confirm hire outcomes for completed interns" icon="fa-user-check" bodyClass="supervisor-page">
      {modal && (
        <AbsorptionModal
          internship={modal}
      ...
      <div className="content-card mb-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-5 text-muted">No completed internships yet. Absorption is only available after completion.</div>
        ) : (
