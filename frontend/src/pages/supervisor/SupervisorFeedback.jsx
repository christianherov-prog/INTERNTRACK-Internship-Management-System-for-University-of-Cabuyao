...
function SupervisorFeedback() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Feedback submitted. Coordinators have been notified.' })
      setFeedback('')
      setInternshipId('')
      load()
    } catch (err) {
          ...
          <div className="row g-3">
            ...
            <div className="col-md-7">
              ...
              <textarea
                ...
                placeholder="Write workplace guidance or remarks for the student…"
                required
                minLength={5}
              />
            </div>
                ...
                <tbody>
                  {feedbackRows.length === 0 ? (
                    ...
                    <tr key={row.id}>
                      ...
                      <td style={{ maxWidth: 360 }}>{row.supervisor_feedback}</td>
