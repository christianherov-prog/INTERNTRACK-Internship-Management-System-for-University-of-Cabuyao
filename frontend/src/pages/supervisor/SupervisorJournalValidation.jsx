          ...
          <div className="modal-body">
            <div className="mb-3 p-3 rounded" style={{background:'#f8fafc',fontSize:'0.88rem'}}>
              <div className="fw-semibold mb-1">
                Week {journal.week_number ?? journal.entry_number} · Hours: {journal.hours_declared}
              </div>
              ...
              <div className="mb-3 text-center">
                {isImage ? (
                  ...
                  <div>
                    ...
                    <a
                      href={`${BACKEND_URL}/storage/${journal.file_path}`}
                      target="_blank"
                      rel="noreferrer"
              ...
              <div key={j.id} className="p-3 border-bottom">
                <div className="d-flex align-items-start justify-content-between">
                  <div>
                    ...
                    <div className="text-muted" style={{fontSize:'0.82rem'}}>{j.hours_declared} hrs declared</div>
                    {j.notes && (
                    ...
                    <div className="mt-1 d-flex align-items-center gap-2">
                      ...
                      {hasFile && (
                        <a
                          href={`${BACKEND_URL}/storage/${j.file_path}`}
                          target="_blank"
                          rel="noreferrer"
